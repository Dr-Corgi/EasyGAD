#!/bin/bash
# SeqKD Stage with LoRA - Supervised Fine-tuning on Teacher Responses
# LoRA mode for parameter-efficient fine-tuning
# Usage: ./run_seqkd_lora.sh --model <model_path> --train_files <train_file> --val_files <val_file> --exp_name <exp_name> --nnodes <nnodes> [--lora_rank <rank>]
set -x
...
echo "=============================================="
echo "Starting SeqKD Training with LoRA"
