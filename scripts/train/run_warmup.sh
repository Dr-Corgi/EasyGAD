#!/bin/bash
# Warmup Stage - Initialize Discriminator and Warm up Student
# Usage: ./run_warmup.sh --model <model_path> --reward_model <reward_model_path> --train_files <train_file> --val_files <val_file> --exp_name <exp_name> --nnodes <nnodes>
set -x
...
# 可选：设置为 'local' 使用离线模式，'cloud' 使用云端模式
