#!/bin/bash
# Warmup Stage with LoRA - Initialize Discriminator and Warm up Student
# LoRA mode for parameter-efficient fine-tuning
# Usage: ./run_warmup_lora.sh --model <model_path> --reward_model <reward_model_path> --train_files <train_file> --val_files <val_file> --exp_name <exp_name> --nnodes <nnodes> [--lora_rank <rank>]
set -x
...
echo "=============================================="
echo "Starting Warmup Training with LoRA"
