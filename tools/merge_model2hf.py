...
"""
Merge distributed model checkpoints to HuggingFace format.

This script converts FSDP-sharded model checkpoints into a single
HuggingFace-compatible model checkpoint.
"""
...
def merge_by_placement(tensors: List[torch.Tensor], placement: Placement):
    """Merge tensors based on their placement strategy."""
