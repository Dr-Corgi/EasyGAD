...
def rearrange_micro_batches(batch, max_token_len, compute_teacher=False, dp_group=None, num_batches_divided_by=None, same_micro_num_in_dp=True, min_num_micro_batch=None):
    """
